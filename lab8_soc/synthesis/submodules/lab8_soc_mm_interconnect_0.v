...
module lab8_soc_mm_interconnect_0 (
		...
		input  wire        audio_data_0_RESET_reset_bridge_in_reset_reset, // audio_data_0_RESET_reset_bridge_in_reset.reset
		...
		output wire [10:0] audio_data_0_avl_address,                       //                         audio_data_0_avl.address
		output wire        audio_data_0_avl_write,                         //                                         .write
		output wire        audio_data_0_avl_read,                          //                                         .read
		input  wire [31:0] audio_data_0_avl_readdata,                      //                                         .readdata
		output wire [31:0] audio_data_0_avl_writedata,                     //                                         .writedata
		output wire [3:0]  audio_data_0_avl_byteenable,                    //                                         .byteenable
		output wire        audio_data_0_avl_chipselect,                    //                                         .chipselect
	...
	wire   [31:0] audio_data_0_avl_agent_m0_readdata;                                                 // audio_data_0_avl_translator:uav_readdata -> audio_data_0_avl_agent:m0_readdata
	wire          audio_data_0_avl_agent_m0_waitrequest;                                              // audio_data_0_avl_translator:uav_waitrequest -> audio_data_0_avl_agent:m0_waitrequest
	wire          audio_data_0_avl_agent_m0_debugaccess;                                              // audio_data_0_avl_agent:m0_debugaccess -> audio_data_0_avl_translator:uav_debugaccess
	wire   [27:0] audio_data_0_avl_agent_m0_address;                                                  // audio_data_0_avl_agent:m0_address -> audio_data_0_avl_translator:uav_address
	wire    [3:0] audio_data_0_avl_agent_m0_byteenable;                                               // audio_data_0_avl_agent:m0_byteenable -> audio_data_0_avl_translator:uav_byteenable
	wire          audio_data_0_avl_agent_m0_read;                                                     // audio_data_0_avl_agent:m0_read -> audio_data_0_avl_translator:uav_read
	wire          audio_data_0_avl_agent_m0_readdatavalid;                                            // audio_data_0_avl_translator:uav_readdatavalid -> audio_data_0_avl_agent:m0_readdatavalid
	wire          audio_data_0_avl_agent_m0_lock;                                                     // audio_data_0_avl_agent:m0_lock -> audio_data_0_avl_translator:uav_lock
	wire   [31:0] audio_data_0_avl_agent_m0_writedata;                                                // audio_data_0_avl_agent:m0_writedata -> audio_data_0_avl_translator:uav_writedata
	wire          audio_data_0_avl_agent_m0_write;                                                    // audio_data_0_avl_agent:m0_write -> audio_data_0_avl_translator:uav_write
	wire    [2:0] audio_data_0_avl_agent_m0_burstcount;                                               // audio_data_0_avl_agent:m0_burstcount -> audio_data_0_avl_translator:uav_burstcount
	wire          audio_data_0_avl_agent_rf_source_valid;                                             // audio_data_0_avl_agent:rf_source_valid -> audio_data_0_avl_agent_rsp_fifo:in_valid
	wire  [106:0] audio_data_0_avl_agent_rf_source_data;                                              // audio_data_0_avl_agent:rf_source_data -> audio_data_0_avl_agent_rsp_fifo:in_data
	wire          audio_data_0_avl_agent_rf_source_ready;                                             // audio_data_0_avl_agent_rsp_fifo:in_ready -> audio_data_0_avl_agent:rf_source_ready
	wire          audio_data_0_avl_agent_rf_source_startofpacket;                                     // audio_data_0_avl_agent:rf_source_startofpacket -> audio_data_0_avl_agent_rsp_fifo:in_startofpacket
	wire          audio_data_0_avl_agent_rf_source_endofpacket;                                       // audio_data_0_avl_agent:rf_source_endofpacket -> audio_data_0_avl_agent_rsp_fifo:in_endofpacket
	wire          audio_data_0_avl_agent_rsp_fifo_out_valid;                                          // audio_data_0_avl_agent_rsp_fifo:out_valid -> audio_data_0_avl_agent:rf_sink_valid
	wire  [106:0] audio_data_0_avl_agent_rsp_fifo_out_data;                                           // audio_data_0_avl_agent_rsp_fifo:out_data -> audio_data_0_avl_agent:rf_sink_data
	wire          audio_data_0_avl_agent_rsp_fifo_out_ready;                                          // audio_data_0_avl_agent:rf_sink_ready -> audio_data_0_avl_agent_rsp_fifo:out_ready
	wire          audio_data_0_avl_agent_rsp_fifo_out_startofpacket;                                  // audio_data_0_avl_agent_rsp_fifo:out_startofpacket -> audio_data_0_avl_agent:rf_sink_startofpacket
	wire          audio_data_0_avl_agent_rsp_fifo_out_endofpacket;                                    // audio_data_0_avl_agent_rsp_fifo:out_endofpacket -> audio_data_0_avl_agent:rf_sink_endofpacket
	wire          cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> audio_data_0_avl_agent:cp_valid
	wire  [105:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> audio_data_0_avl_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // audio_data_0_avl_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [15:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> audio_data_0_avl_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> audio_data_0_avl_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> audio_data_0_avl_agent:cp_endofpacket
	...
	wire  [105:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> i2c_0_csr_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // i2c_0_csr_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [15:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> i2c_0_csr_agent:cp_channel
	...
	wire   [15:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> nios2_gen2_0_debug_mem_slave_agent:cp_channel
	...
	wire   [15:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> sdram_pll_pll_slave_agent:cp_channel
	...
	wire          audio_data_0_avl_agent_rp_valid;                                                    // audio_data_0_avl_agent:rp_valid -> router_003:sink_valid
	wire  [105:0] audio_data_0_avl_agent_rp_data;                                                     // audio_data_0_avl_agent:rp_data -> router_003:sink_data
	wire          audio_data_0_avl_agent_rp_ready;                                                    // router_003:sink_ready -> audio_data_0_avl_agent:rp_ready
	wire          audio_data_0_avl_agent_rp_startofpacket;                                            // audio_data_0_avl_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          audio_data_0_avl_agent_rp_endofpacket;                                              // audio_data_0_avl_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          audio_data_0_avl_agent_rdata_fifo_src_valid;                                        // audio_data_0_avl_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] audio_data_0_avl_agent_rdata_fifo_src_data;                                         // audio_data_0_avl_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          audio_data_0_avl_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_001:in_0_ready -> audio_data_0_avl_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> audio_data_0_avl_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> audio_data_0_avl_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                  // audio_data_0_avl_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> audio_data_0_avl_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) audio_data_0_avl_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (audio_data_0_RESET_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (audio_data_0_avl_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (audio_data_0_avl_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (audio_data_0_avl_agent_m0_read),                 //                         .read
		.uav_write              (audio_data_0_avl_agent_m0_write),                //                         .write
		.uav_waitrequest        (audio_data_0_avl_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (audio_data_0_avl_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (audio_data_0_avl_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (audio_data_0_avl_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (audio_data_0_avl_agent_m0_writedata),            //                         .writedata
		.uav_lock               (audio_data_0_avl_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (audio_data_0_avl_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (audio_data_0_avl_address),                       //      avalon_anti_slave_0.address
		.av_write               (audio_data_0_avl_write),                         //                         .write
		.av_read                (audio_data_0_avl_read),                          //                         .read
		.av_readdata            (audio_data_0_avl_readdata),                      //                         .readdata
		.av_writedata           (audio_data_0_avl_writedata),                     //                         .writedata
		.av_byteenable          (audio_data_0_avl_byteenable),                    //                         .byteenable
		.av_chipselect          (audio_data_0_avl_chipselect),                    //                         .chipselect
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
		.av_readdatavalid       (1'b0),                                           //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) audio_data_0_avl_agent (
		.clk                     (clk_0_clk_clk),                                     //             clk.clk
		.reset                   (audio_data_0_RESET_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (audio_data_0_avl_agent_m0_address),                 //              m0.address
		.m0_burstcount           (audio_data_0_avl_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (audio_data_0_avl_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (audio_data_0_avl_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (audio_data_0_avl_agent_m0_lock),                    //                .lock
		.m0_readdata             (audio_data_0_avl_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (audio_data_0_avl_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (audio_data_0_avl_agent_m0_read),                    //                .read
		.m0_waitrequest          (audio_data_0_avl_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (audio_data_0_avl_agent_m0_writedata),               //                .writedata
		.m0_write                (audio_data_0_avl_agent_m0_write),                   //                .write
		.rp_endofpacket          (audio_data_0_avl_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (audio_data_0_avl_agent_rp_ready),                   //                .ready
		.rp_valid                (audio_data_0_avl_agent_rp_valid),                   //                .valid
		.rp_data                 (audio_data_0_avl_agent_rp_data),                    //                .data
		.rp_startofpacket        (audio_data_0_avl_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (audio_data_0_avl_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (audio_data_0_avl_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (audio_data_0_avl_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (audio_data_0_avl_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (audio_data_0_avl_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (audio_data_0_avl_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (audio_data_0_avl_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (audio_data_0_avl_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (audio_data_0_avl_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (audio_data_0_avl_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                 // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                 //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                  //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                 //                .error
		.rdata_fifo_src_ready    (audio_data_0_avl_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (audio_data_0_avl_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (audio_data_0_avl_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                             //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                               //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) audio_data_0_avl_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                     //       clk.clk
		.reset             (audio_data_0_RESET_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (audio_data_0_avl_agent_rf_source_data),             //        in.data
		.in_valid          (audio_data_0_avl_agent_rf_source_valid),            //          .valid
		.in_ready          (audio_data_0_avl_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (audio_data_0_avl_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (audio_data_0_avl_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (audio_data_0_avl_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (audio_data_0_avl_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (audio_data_0_avl_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (audio_data_0_avl_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (audio_data_0_avl_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                             // (terminated)
		.csr_read          (1'b0),                                              // (terminated)
		.csr_write         (1'b0),                                              // (terminated)
		.csr_readdata      (),                                                  // (terminated)
	...
	lab8_soc_mm_interconnect_0_router_002 router_003 (
		.sink_ready         (audio_data_0_avl_agent_rp_ready),                //      sink.ready
		.sink_valid         (audio_data_0_avl_agent_rp_valid),                //          .valid
		.sink_data          (audio_data_0_avl_agent_rp_data),                 //          .data
		.sink_startofpacket (audio_data_0_avl_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (audio_data_0_avl_agent_rp_endofpacket),          //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (audio_data_0_RESET_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (audio_data_0_RESET_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (audio_data_0_avl_agent_rdata_fifo_src_data),     //     in_0.data
		.in_0_valid     (audio_data_0_avl_agent_rdata_fifo_src_valid),    //         .valid
		.in_0_ready     (audio_data_0_avl_agent_rdata_fifo_src_ready),    //         .ready
