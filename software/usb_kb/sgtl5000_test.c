/*
//SGT5000 register control with the Intel FPGA I2C peripheral
...
int main()
{
	...
	// i2c_dev = alt_avalon_i2c_open("/dev/i2c0"); //this has to reflect Platform Designer name
	...
	//alt_avalon_i2c_master_target_set(i2c_dev,0x080050c0);
